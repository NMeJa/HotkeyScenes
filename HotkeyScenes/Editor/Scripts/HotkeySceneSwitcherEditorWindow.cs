...
namespace NMJ.HotkeyScenes
{
	public class HotkeySceneSwitcherEditorWindow : EditorWindow
	{
		...
		private static bool openDuringPlayMode = false;

		[MenuItem(cMenuPath + "Only EditMode")] private static void ToggleOnlyEditMode() => openDuringPlayMode = false;
		[MenuItem(cMenuPath + "Only EditMode", true)] private static bool ToggleOnlyEditModeValidation() => openDuringPlayMode;

		[MenuItem(cMenuPath + "EveryWhere")] private static void ToggleEveryWhere() => openDuringPlayMode = true;
		[MenuItem(cMenuPath + "EveryWhere", true)] private static bool ToggleEveryWhereValidation() => !openDuringPlayMode;
		...
		[MenuItem(cMenuPath + "Edit %#e", true)]
		[MenuItem(cMenuPath + "Scene 0 %#0", true)]
		[MenuItem(cMenuPath + "Scene 1 %#1", true)]
		[MenuItem(cMenuPath + "Scene 2 %#2", true)]
		[MenuItem(cMenuPath + "Scene 3 %#3", true)]
		[MenuItem(cMenuPath + "Scene 4 %#4", true)]
		[MenuItem(cMenuPath + "Scene 5 %#5", true)]
		[MenuItem(cMenuPath + "Scene 6 %#6", true)]
		[MenuItem(cMenuPath + "Scene 7 %#7", true)]
		[MenuItem(cMenuPath + "Scene 8 %#8", true)]
		[MenuItem(cMenuPath + "Scene 9 %#9", true)]
		private static bool ValidateUsage() => !EditorApplication.isPlaying || openDuringPlayMode;
